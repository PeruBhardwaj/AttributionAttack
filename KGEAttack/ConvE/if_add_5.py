...
### Load the influential triples from deletions and replace the subject or object with most distant entity in cosine
...
save_path = 'data/{5}_add_5_{0}_{1}_{2}_{3}_{4}'.format(args.model, args.data, 
                                                    args.target_split, args.budget, args.rand_run,
                                                    args.sim_metric
                                                                )
