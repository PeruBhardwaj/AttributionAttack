...
def get_decoy_o_addition(triple, model, train_data, composition_relation):
    ...
    return max_val_o, adv_o_l, adv_o_r, decoy_o
...
def get_decoy_s_addition(triple, model, train_data, composition_relation):
    ...
    return max_val_s, adv_s_l, adv_s_r, decoy_s
...
def get_additions(train_data, test_data, model):
    ...
    #     
    # 2. select decoy triple based on cosine distance from target entity
...
if __name__ == '__main__':
    ...
    log_path = 'logs/attack_logs/com_add_3_{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, 
    ...
    logger.info('-------------------- Edits with Composition Attack - cosine ----------------------')
    ...
    save_path = 'data/com_add_3_{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, 
                                                               args.target_split, args.budget, args.rand_run)
    ...
    with open(os.path.join(save_path, 'stats.txt'), 'w') as f:
        ...
        f.write('----------------------Composition Add 3 (Cosine)------------------------------- \n')
