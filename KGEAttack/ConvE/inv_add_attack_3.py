...
def get_additions(train_data, test_data, model):
    ...
    #     
    # 2. For every test triple, choose o' with max cos distance on o-side and choose s' with max cos distance on s-side
...
if __name__ == '__main__':
    ...
    log_path = 'logs/attack_logs/inv_add_3_{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, 
    ...
    logger.info('-------------------- Edits with Inverse Attack - cosine ----------------------')
    ...
    save_path = 'data/inv_add_3_{0}_{1}_{2}_{3}_{4}'.format( args.model, args.data, 
                                                               args.target_split, args.budget, args.rand_run)
